 ...
 */
static void 
netdev_no_ret(struct net_device *netdev)//, unsigned int txqueue) 
{
	(void)netdev;
	return;
}
static void
netdev_no_ret_latest(struct net_device *netdev, unsigned int txqueue) 
{
        (void)netdev;
        return;
}
...
static const struct net_device_ops netdev_ops = {
        ...
        .ndo_change_mtu         = NULL,
        .ndo_tx_timeout         = netdev_no_ret_latest,
